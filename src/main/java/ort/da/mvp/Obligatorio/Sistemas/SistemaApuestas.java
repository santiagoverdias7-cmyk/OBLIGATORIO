...
public class SistemaApuestas {
   ...
   /*  public ModalidadApuesta buscarModalidad(String nombre) {
    ...
    public void registrarApuesta(Apuesta apuesta) {
        ...
        apuesta.getParticipacion().agregarApuesta(apuesta);
        apuesta.getParticipacion().getCarrera().recalcularDividendos(comision);
        apuesta.getParticipacion().getCarrera().recalcularEstado();
    }
}
